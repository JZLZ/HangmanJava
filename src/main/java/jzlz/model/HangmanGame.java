...
import static jzlz.model.HangmanGameStatus.*;
...
public class HangmanGame {
    ...
    public HangmanGame(final List<HangmanChar>characters) {
        ...
        this.characters = setLetterSpacesPositionInGame(characters, whiteSpaces.length());
    ...
    private List<HangmanChar> setLetterSpacesPositionInGame(final List<HangmanChar>characters, final int whiteSpacesAmount){
